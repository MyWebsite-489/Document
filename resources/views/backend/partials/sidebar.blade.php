            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview {{ \App\Helpers\Common::setTreeViewOpen($subMenuTopicDocument) }}">
                    <a href="" class="nav-link {{ \App\Helpers\Common::setActive($subMenuTopicDocument) }}">
                        <i class="nav-icon fa fa-pencil-square-o"></i>
                        <p>Quản lý tài liệu<i class="right fa fa-angle-left"></i></p>
                    </a>
                    <ul class="nav nav-treeview">
                        @php
                            $nameTopicDocument = ['admin.topic-document.index'];
                        @endphp
                        <li class="nav-item">
                            <a href="{{ route('admin.topic-document.index') }}"
                               class="nav-link {{ \App\Helpers\Common::setActive($nameTopicDocument) }}">
                                <i class="fa fa-th-list nav-icon"></i>
                                <p>Tài liệu</p>
                            </a>
                        </li>
