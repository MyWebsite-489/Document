                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header navbar-light">
                                <div class="row">
                                    <div class="col-md-8">
                                        <form method="GET" action="{{ route('admin.post.posts') }}"
                                    ...
                                    <div class="col-md-4 text-right">
                                        <a class="btn btn-primary btn-sm" href="{{ route('admin.post.create') }}">
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    @foreach ($posts as $key => $post)
                                                        <tr>
                                                            <td>
                                                                <span>{{ request()->has('page') ? (request()->get('page') - 1) * 10 + $key + 1 : '' }}</span>
                                                            </td>
                                                            <td>
                                                                <span class="thumbnail-post">
                                                                    <img src="{{ asset($post->thumbnail) }}" width="50%"
                                                                        alt="Image">
                                                                </span>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                @foreach ($post->topics as $keyTopic => $topic)
                                                            ...
                                                            <td class="text-center">
                                                                <span class="badge bg-success">
                                                                    {{ \App\Models\Post::STATUS[$post->status] }}
                                                                </span>
                                                            </td>
                                                            <td>
                                                                <a href="{{ route('admin.post.edit', ['id' => $post->id]) }}"
...
@section('addJs')
    ...
    <script src="{{ asset('admins/common/js/post.js') }}"></script>
