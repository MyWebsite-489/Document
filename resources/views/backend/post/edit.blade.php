...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ route('admin.post.update', ['id' => request()->id]) }}" class=""
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 right-sidebar">
                            <div class="">
                                                                ...
                                                                <li value="{{ $topic->id }}">
                                                                    <label>
                                                                        <input type="checkbox" value="{{ $topic->id }}"
                                                                            name="topics[]"
                                                                            {{ in_array($topic->id, $post->topics) ? 'checked' : '' }}>
                                                                        {{ $topic->name }}
                                                                    </label>
                                                                </li>
                                                            @endforeach
                                ...
                                <div class="widget meta-boxes">
                                    <div class="widget-title">
                                        <h4><label>Image<code>*</code></label></h4>
                                    </div>
                                    <div class="widget-body">
                                        <div class="image-box">
                                            <input type="hidden" name="image" value="" class="image-data">
                                            <div class="preview-image-wrapper ">
                                                <img src="{{ asset($post->thumbnail) }}" alt="Preview image"
                                            ...
                                            <div class="image-box-actions">
                                                <input type="file" accept=".png,.jpg,.jpeg,.gif" accept="image/png" value=""
                                                    name="thumbnail" class="btn_gallery d-none">
                                                @error('thumbnail')
                                                    <small class="form-text text-muted">{{ $message }}</small>
                                                @enderror
                                            </div>
