...
@section('content')
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Tài liệu</h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header navbar-light">
                                <div class="row">
                                    <div class="col-md-8">
                                        <form method="GET" action="{{ route('admin.topic-document.index') }}"
                                    ...
                                    <div class="col-md-4 text-right">
                                        ...
                                        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                                data-target="#topic-document-modal">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                                <span class="badge bg-success">
                                                                    {{ \App\Models\TopicDocument::STATUS[$topic->status] }}
                                                                </span>
                                                        </td>
                                                        <td>
                                                            <button onclick="getTopicDocumentDetail({{ $topic->id }})"
    ...
    <!-- Modal create topic -->
    @include('backend.topic-document.create')
    <!-- Modal create topic -->
...
@section('addJs')
    ...
    <script src="{{ asset('admins/common/js/topic_document.js') }}"></script>
