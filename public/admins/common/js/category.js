$(function () {
    ...
    $("#update-category").submit(function (e) {
        e.preventDefault();
        let form = $(this).serializeArray();
        let categoryId = $("#id-category").val();
...
function getCategoryDetail(id) {
    ...
    $.ajax({
        method: "GET",
        url: `/admin/categories/detail/${id}`,
        processData: false,
        contentType: false,
        cache: false,
        success: (data) => {
            if (data.success) {
                ...
                $("#id-category").val(categoryData.id);
                $("#name-category").val(categoryData.name);
                $("#description-category").val(categoryData.description);
                $("#status-category").val(categoryData.status);
                $("#thumbnail-category").attr(
                    "src",
